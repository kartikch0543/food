                    ...
                    <div className="flex items-center gap-8">
                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-2">
                                <span className="text-rose-600 font-black text-[10px] uppercase tracking-[0.4em] italic bg-rose-50 px-3 py-1 rounded-lg">Inventory Management</span>
                            </div>
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 uppercase tracking-tighter italic leading-none">{restaurant.name} <span className="text-rose-600">Manifest.</span></h1>
                        </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-8 mt-20 grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                <div className="lg:col-span-4">
                    <div className="bg-white p-12 rounded-[4rem] shadow-2xl border border-gray-100 overflow-hidden relative group/form">
                        ...
                        <h2 className="text-2xl font-black text-gray-900 mb-12 uppercase tracking-tighter flex items-center gap-4 italic relative z-10 leading-none">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-10 relative z-10">
                            <div className="space-y-3">
                                <label className="text-[10px] font-black uppercase text-gray-400 tracking-[0.4em] ml-4 italic">Culinary Designation</label>
                                <input required type="text" value={name} onChange={e => setName(e.target.value)} placeholder="e.g. Saffron Risotto" className="w-full px-8 py-6 bg-gray-50 border border-gray-100 rounded-2xl focus:bg-white focus:ring-12 focus:ring-rose-500/5 transition-all outline-none font-bold text-xl" />
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-8">
                                <div className="space-y-3">
                                    <label className="text-[10px] font-black uppercase text-gray-400 tracking-[0.4em] ml-4 italic">Price Point</label>
                                    <div className="relative">
                                        <IndianRupee className="absolute left-6 top-1/2 -translate-y-1/2 h-5 w-5 text-rose-600" />
                                        <input required type="number" step="0.01" value={price} onChange={e => setPrice(Number(e.target.value))} className="w-full pl-14 pr-6 py-6 bg-gray-50 border border-gray-100 rounded-2xl focus:bg-white focus:ring-12 focus:ring-rose-500/5 transition-all outline-none font-black text-xl" />
                                    </div>
                                </div>
                                <div className="space-y-3">
                                    <label className="text-[10px] font-black uppercase text-gray-400 tracking-[0.4em] ml-4 italic">Classification</label>
                                    <input required type="text" value={category} onChange={e => setCategory(e.target.value)} placeholder="Signature" className="w-full px-7 py-6 bg-gray-50 border border-gray-100 rounded-2xl focus:bg-white focus:ring-12 focus:ring-rose-500/5 transition-all outline-none font-black text-[11px] uppercase tracking-[0.3em]" />
                                </div>
                            </div>

                            <div className="space-y-3">
                                <label className="text-[10px] font-black uppercase text-gray-400 tracking-[0.4em] ml-4 italic">Narrative / Description</label>
                                    ...
                                    <div className="p-12 flex flex-col flex-1">
                                        <div className="flex justify-between items-start gap-6 mb-8">
                                            <div className="max-w-[70%]">
                                                ...
                                                <h3 className="text-3xl font-black text-gray-900 group-hover:text-rose-600 transition-colors uppercase tracking-tighter italic leading-none whitespace-normal break-words">{f.name}</h3>
                                            </div>
                                            <div className="flex items-center gap-1.5 font-black text-gray-900 italic bg-gray-50 px-5 py-3 rounded-2xl border border-gray-100">
