    ...
    if (!cart?.items.length) return (
        <div className="min-h-screen bg-[#fafafa] flex items-center justify-center p-8">
            <div className="max-w-2xl w-full text-center p-24 bg-white rounded-[4rem] border border-gray-100 shadow-2xl animate-in zoom-in duration-700">
                ...
                <h1 className="text-5xl font-black text-gray-900 uppercase tracking-tighter mb-6 italic leading-tight">Folder <br /> <span className="text-rose-600">Empty.</span></h1>
        ...
        <div className="min-h-screen bg-[#fafafa] pb-32">
            ...
            <div className="max-w-7xl mx-auto px-10 grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    {cart.items.map((item) => (
                        <div key={item.foodId?._id} className="group bg-white p-10 rounded-[3rem] border border-gray-100 flex flex-col md:flex-row items-center gap-10 hover:shadow-2xl hover:shadow-black/[0.03] transition-all duration-700 shadow-sm relative overflow-hidden">
                            ...
                            <div className="flex-1 text-center md:text-left relative z-10">
                                ...
                                <h3 className="text-2xl md:text-3xl font-black text-gray-900 uppercase italic tracking-tighter mb-4 group-hover:text-rose-600 transition-colors leading-tight">{item.foodId?.name}</h3>
                ...
                <div className="lg:col-span-4">
                    <div className="bg-white p-12 rounded-[4rem] text-gray-900 shadow-2xl sticky top-[120px] border border-rose-50 shadow-rose-900/5 overflow-hidden group">
                        <div className="absolute top-0 right-0 p-12 text-rose-500/10 group-hover:rotate-12 transition-transform duration-1000">
                            <ShoppingCart className="h-48 w-48 -mr-16 -mt-16" />
                        </div>

                        <div className="flex items-center gap-4 mb-12 relative z-10">
                            <div className="h-2.5 w-2.5 rounded-full bg-rose-600 animate-pulse" />
                            <h2 className="text-3xl font-black uppercase italic tracking-tighter leading-tight">Order <span className="text-rose-600">Impact.</span></h2>
                        </div>
                        ...
                        <div className="space-y-8 mb-12 relative z-10">
                            ...
                            <div className="flex justify-between items-end">
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 font-black text-5xl italic tracking-tighter text-gray-900">
                                        <IndianRupee className="h-7 w-7 text-rose-600 ml-[-8px]" />
                                        {(total + 45).toFixed(2)}
                                    </div>
                                </div>
                            </div>
